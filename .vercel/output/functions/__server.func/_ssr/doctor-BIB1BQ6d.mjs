...
import { t as DOCTOR } from "./supabase-DdBqf3_N.mjs";
import { t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { p as require_jsx_runtime } from "../_libs/@radix-ui/react-checkbox+[...].mjs";
import { a as useClinic, i as triage, r as symptomLabel } from "./clinic-store-BX03xbk7.mjs";
import { _ as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as loginDoctor, r as logoutDoctor, t as Route } from "./doctor-BJoT3XBw.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/doctor-BIB1BQ6d.js
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
								...
								children: [
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
												...
												children: [
													...
													"Nearby Facilities to ",
													session.campus || "Patient"
												]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-[10px] text-muted-foreground",
												children: "1-Click Select"
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "grid gap-1.5 max-h-48 overflow-y-auto pr-1",
											children: FALLBACK_FACILITIES.slice(0, 5).map((fac, idx) => {
												...
												return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: cn("flex items-center justify-between p-2 rounded-lg border text-xs transition-colors cursor-pointer", isSelected ? "border-primary bg-primary/10" : "border-border/60 bg-muted/40 hover:bg-muted/80"),
													onClick: () => {
														if (!ended) setReferral((prev) => ({
															...prev,
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											htmlFor: "dest",
											children: "Destination Facility (Selected)"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
											id: "dest",
											disabled: ended,
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										...
										children: "End Session & Issue Referral Letter"
									})
								]
							})
						]
