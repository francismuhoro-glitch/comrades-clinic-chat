...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DehOmSPK.mjs";
...
import { n as requestHandler, t as getResponse } from "./request-response-Dtzl9ZrW.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DcBjVNHl.mjs");
