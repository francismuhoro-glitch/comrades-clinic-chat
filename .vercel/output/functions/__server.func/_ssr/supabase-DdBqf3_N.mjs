import { t as FunctionsClient } from "../_libs/supabase__functions-js.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/supabase-DdBqf3_N.js
var DOCTOR = {
...
function getEnv(key) {
	if (typeof import.meta !== "undefined" && {
		...
		"VITE_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl1amlsemVyanhhZ2h4bGlxd3dpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcyODM4ODAsImV4cCI6MjEwMjg1OTg4MH0.OhqBJqL1hbFFBt02sb1VednnbspcT5jibewv-u7FmoQ",
		"VITE_SUPABASE_URL": "https://yujilzerjxaghxliqwwi.supabase.co"
	}[key]) return {
		"BASE_URL": "/",
		"DEV": false,
		"MODE": "production",
...
var supabase = createClient(getEnv("VITE_SUPABASE_URL") || "https://placeholder-project.supabase.co", getEnv("VITE_SUPABASE_ANON_KEY") || "placeholder-anon-key");
//#endregion
export { supabase as n, DOCTOR as t };
