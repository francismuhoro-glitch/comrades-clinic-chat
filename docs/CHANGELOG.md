...
| next    | WhatsApp site-help fallback             | Persistent “Trouble with the site? WhatsApp us” link (patient header icon + footers on `/` and `/doctor`), opens wa.me with prefilled message; number editable in Doctor Portal → Clinic Settings                                                                                                  | Run `20260925120000`                                                                                           |
| next    | Mobile declutter (landing + intake)     | Shorter hero with Start CTA, mood check-in collapsed by default, compact emergency strip, titles-only services grid on phones, tighter intake copy, optional email collapsed, 2-col quick answers                                                                                                  | —                                                                                                              |
| next    | WhatsApp button promoted to top of page | Patient header now shows a prominent WhatsApp button and the landing page a full-width "Trouble with the site? WhatsApp us" call to action (reverses the "visually secondary" styling from the PR above); official WhatsApp glyph inlined as SVG (no new dependency, no third-party widget script) | —                                                                                                              |
...
13. `20260831120000_psychiatrist_role_and_therapy_pricing.sql`
14. `20260925120000_whatsapp_number.sql`
